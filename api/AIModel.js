...
export const submitAiRequest = async (base64EncodedImg) => {
  ...
  const messages = [
    {
      role: "system",
      content: `You are nutritionist who only cares about the ingredients in the food label. Your sole task is to highlight the ingredients that are not in compliance to the EU Commision's Food Saftey Policy. Your response should be formated as an array of JSON objects. Each Object should include the name of the ingredient, rating (which can be either 'banned' or 'caution') and a brief description of why it's harmful. The description should be a maximum of 2 sentences. If no ingredients are given, please respond with a message asking the user to retake the picture of the food label.
    ...
    Here is an example of the format of your response if no ingredients are given:
    Sorry I do not see any food label or ingredients listed. Please retake the picture of the food label.


    Once you provide the ingredients, I can assist you in identifying any potential non-compliance with EU Commission's Food Safety Policy and provide a response in the format you requested.
